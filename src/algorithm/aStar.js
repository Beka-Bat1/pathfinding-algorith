export function astar(nodes, startNode, target, boardArray, name, heuristic) {
    ...
    while (!!unvisitedNodes.length) {
      ...
      updateNeighbors(nodes, currentNode, boardArray, target, name, startNode, heuristic);
    }
  }
  ...
  function updateNeighbors(nodes, node, boardArray, target, name, startNode, heuristic) {
    let neighbors = getNeighbors(node.id, nodes, boardArray);
    for (let neighbor of neighbors) {
      if (target) {
        updateNode(node, nodes[neighbor], nodes[target], name, nodes, startNode, heuristic, boardArray);
      } else {
